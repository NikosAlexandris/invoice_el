...
\setkomavar{fromlogo}{\includegraphics[clip, width=3cm, height=3cm]{qr_coded_mecard_template}\\
...
\makeatother
%\setkomavar{signature}{Με εκτίμηση,\\\includegraphics[width=84mm, height=24mm, keepaspectratio, draft]{signature}\\
