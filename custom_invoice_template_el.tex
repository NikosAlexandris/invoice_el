...
\setkomavar{signature}{Με εκτίμηση,\\\includegraphics[width=84mm, height=24mm, keepaspectratio, bb = 0 0 200 100, draft, type=eps]{signature}\\
...
% Custom variables
% \providecaptionname{greek}\fromvatin{ΑΦΜ}%	Does not work!
\newcaptionname{greek}\yourvatinname{ΑΦΜ}%	Does not work!
}